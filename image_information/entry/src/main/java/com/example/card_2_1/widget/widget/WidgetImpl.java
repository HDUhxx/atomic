package com.example.card_2_1.widget.widget;

import com.example.card_2_1.ResourceTable;
import com.example.card_2_1.widget.controller.FormController;
...
public class WidgetImpl extends FormController {
    ...
    static {
        RESOURCE_ID_MAP.put(DIMENSION_1X2, ResourceTable.Layout_form_image_with_information_widget_1_2);
