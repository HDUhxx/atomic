 ...
 * @since 2021-04-29
 */
public class PaddingImageView extends Image {
    /**
     * PaddingImageView
     *
     * @param context
     ...
     * @param attrs
     */
    public PaddingImageView(Context context, AttrSet attrs) {
        this(context, attrs, "");
    }
     ...
     * @param styleName
     */
    public PaddingImageView(Context context, AttrSet attrs, String styleName) {
