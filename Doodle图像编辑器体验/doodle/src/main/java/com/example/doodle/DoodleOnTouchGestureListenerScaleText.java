 ...
 * @since 2021-05-15
 */
public class DoodleOnTouchGestureListenerScaleText extends TouchGestureDetectorScaleText.OnTouchGestureListener {
    /**
     * VALUE
     */
    ...
    private DoodleOnTouchGestureListenerScaleText.ISelectionListener mSelectionListener;
     ...
     * @param listener
     */
    public DoodleOnTouchGestureListenerScaleText(DoodleView doodle, ISelectionListener listener) {
        mDoodle = doodle;
                ...
                if ((mSelectedItem instanceof DoodleRotatableItemBase) && (((DoodleRotatableItemBase) mSelectedItem).isRotating())) { // 旋转item
                    ...
                    if(aj==0){
                        ...
                        mSelectedItem.setLocation(
                            ...
                            mStartY + mDoodle.toY(mTouchY) - mDoodle.toY(mTouchDownY)-40);
                    }
