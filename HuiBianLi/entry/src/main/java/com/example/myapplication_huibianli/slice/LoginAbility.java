    ...
    private void login(){
        button2.setClickedListener(new Component.ClickedListener() {
            ...
            public void onClick(Component component) {
                ...
                if(button2!=null && name.equals("惠便利") && password.equals("2019")){
                    present(new YudingAbility(),new Intent());
                    new ToastDialog(context).setText("欢迎登陆惠便利").show();
                }else if(button2!=null && name.equals("同区") && password.equals("2019")){
                    present(new YudingAbility(),new Intent());
                    new ToastDialog(context).setText("欢迎登陆惠便利").show();
