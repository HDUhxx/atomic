...
public class VideoAbilitySlice3 extends AbilitySlice {
    ...
    public void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_vedio_layout3);
        ...
        DependentLayout dependentLayout=(DependentLayout)findComponentById(ResourceTable.Id_vediolayout3);
    ...
    private void playLocalFile(Surface surface) {
        ...
        try {
            ...
            RawFileDescriptor filDescriptor = getResourceManager().getRawFileEntry("resources/rawfile/image6.mp4").openRawFileDescriptor();
