...
public class PagerBottomPopup extends BottomPopupView {
    ...
    protected int getImplLayoutId() {
        return ResourceTable.Layout_custom_view_pager;
    }
    ...
    class PAdapter extends PageSliderProvider {
        ...
        public Object createPageInContainer(ComponentContainer componentContainer, int position) {
            ScrollView scrollView = new ScrollView(componentContainer.getContext());
            DirectionalLayout linearLayout = new DirectionalLayout(componentContainer.getContext());
            linearLayout.setOrientation(VERTICAL);
            scrollView.addComponent(linearLayout, new ComponentContainer.LayoutConfig(ComponentContainer.LayoutConfig.MATCH_PARENT, ComponentContainer.LayoutConfig.MATCH_CONTENT));
            ...
            linearLayout.addComponent(textView, new ComponentContainer.LayoutConfig(ComponentContainer.LayoutConfig.MATCH_PARENT, ComponentContainer.LayoutConfig.MATCH_CONTENT));
            Image imageView = new Image(componentContainer.getContext());
            imageView.setPixelMap(ResourceTable.Media_icon);
            linearLayout.addComponent(imageView, new ComponentContainer.LayoutConfig(ComponentContainer.LayoutConfig.MATCH_PARENT, ComponentContainer.LayoutConfig.MATCH_CONTENT));
            componentContainer.addComponent(scrollView, new ComponentContainer.LayoutConfig(ComponentContainer.LayoutConfig.MATCH_PARENT, ComponentContainer.LayoutConfig.MATCH_PARENT));
            return scrollView;
        }
