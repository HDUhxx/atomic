 ...
 * 注：包含ListContainer的View暂不能用含有alpha动画的动画
 */
public enum PopupAnimation {

    // 缩放，不带透明渐变
    ScaleFromCenter, // 从中心进行缩放
    ScaleFromLeftTop, // 从左上角进行缩放
    ScaleFromRightTop, // 从右上角进行缩放
    ScaleFromLeftBottom, // 从左下角进行缩放
    ScaleFromRightBottom, // 从右下角进行缩放
