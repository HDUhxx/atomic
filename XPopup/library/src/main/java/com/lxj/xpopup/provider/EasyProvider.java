 ...
 */
package com.lxj.xpopup.provider;
 ...
 * @param <T> 数据类型
 */
public abstract class EasyProvider<T> extends BaseItemProvider {
     ...
     * @return 适配器对象
     */
    public EasyProvider(Context context, List<T> data, int mLayoutId) {
