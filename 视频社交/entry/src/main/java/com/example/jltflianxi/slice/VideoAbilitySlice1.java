...
public class VideoAbilitySlice1 extends AbilitySlice {
    ...
    public void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_vedio_layout1);
        ...
        DependentLayout dependentLayout=(DependentLayout)findComponentById(ResourceTable.Id_vediolayout1);
    ...
    private void playLocalFile(Surface surface) {
        ...
        try {
            ...
            RawFileDescriptor filDescriptor = getResourceManager().getRawFileEntry("resources/rawfile/index.mp4").openRawFileDescriptor();
