...
public class VideoAbilitySlice5 extends AbilitySlice {
    ...
    public void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_vedio_layout5);
        ...
        DependentLayout dependentLayout=(DependentLayout)findComponentById(ResourceTable.Id_vediolayout5);
    ...
    private void playLocalFile(Surface surface) {
        ...
        try {
            ...
            RawFileDescriptor filDescriptor = getResourceManager().getRawFileEntry("resources/rawfile/image1.mp4").openRawFileDescriptor();
