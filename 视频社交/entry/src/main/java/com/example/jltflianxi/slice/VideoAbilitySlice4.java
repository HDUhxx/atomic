...
public class VideoAbilitySlice4 extends AbilitySlice {
    ...
    public void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_vedio_layout4);
        ...
        DependentLayout dependentLayout=(DependentLayout)findComponentById(ResourceTable.Id_vediolayout4);
    ...
    private void playLocalFile(Surface surface) {
        ...
        try {
            ...
            RawFileDescriptor filDescriptor = getResourceManager().getRawFileEntry("resources/rawfile/image2.mp4").openRawFileDescriptor();
