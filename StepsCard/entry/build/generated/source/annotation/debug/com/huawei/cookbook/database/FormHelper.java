...
/**
 * Generated by ohos.data.orm.processor for form in com.huawei.cookbook.database.FormDatabase. Do not modify!
 *
 * @author Huawei
 * @since 2022-08-08
 */
public class FormHelper implements EntityHelper<Form> {
    ...
    public void bindValue(Statement statement, Form object) {
        ...
        statement.setLong(3, object.getDimension());
    }
    ...
    public Form createInstance(ResultSet resultSet) {
        ...
        object.setDimension(resultSet.getInt(3));
        return object;
    }
