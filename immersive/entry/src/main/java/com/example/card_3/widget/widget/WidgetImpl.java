package com.example.card_3.widget.widget;

import com.example.card_3.ResourceTable;
import com.example.card_3.widget.controller.FormController;
...
public class WidgetImpl extends FormController {
    ...
    static {
        RESOURCE_ID_MAP.put(DIMENSION_1X2, ResourceTable.Layout_form_immersive_pattern_widget_1_2);
        RESOURCE_ID_MAP.put(DEFAULT_DIMENSION_2X2, ResourceTable.Layout_form_immersive_pattern_widget_2_2);
        RESOURCE_ID_MAP.put(DIMENSION_2X4, ResourceTable.Layout_form_immersive_pattern_widget_2_4);
        RESOURCE_ID_MAP.put(DIMENSION_4X4, ResourceTable.Layout_form_immersive_pattern_widget_4_4);
    }
