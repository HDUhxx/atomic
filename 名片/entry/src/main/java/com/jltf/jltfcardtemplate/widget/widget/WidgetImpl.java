package com.jltf.jltfcardtemplate.widget.widget;

import com.jltf.jltfcardtemplate.ResourceTable;
import com.jltf.jltfcardtemplate.widget.controller.FormController;
...
public class WidgetImpl extends FormController {
    ...
    static {
        RESOURCE_ID_MAP.put(DEFAULT_DIMENSION_2X2, ResourceTable.Layout_form_list_pattern_widget_2_2);
        RESOURCE_ID_MAP.put(DIMENSION_4X4, ResourceTable.Layout_form_list_pattern_widget_4_4);
    }
