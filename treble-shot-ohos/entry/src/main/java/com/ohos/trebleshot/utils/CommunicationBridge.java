    ...
    public static class Client extends CoolSocket.Client {
        ...
        public CoolSocket.ActiveConnection handshake(CoolSocket.ActiveConnection activeConnection, boolean handshakeOnly) throws IOException, TimeoutException, CommunicationException {
            try {
                ...
                jsonObject.put(Keyword.HANDSHAKE_REQUIRED, true);
                jsonObject.put(Keyword.HANDSHAKE_ONLY, handshakeOnly);
                jsonObject.put(Keyword.DEVICE_INFO_SERIAL, AppUtils.getDeviceSerial(getContext()));
                jsonObject.put(Keyword.DEVICE_SECURE_KEY, mDevice == null ? mSecureKey : mDevice.tmpSecureKey);
