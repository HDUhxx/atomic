...
public abstract class CoolSocket
{
	...
	private final ServerRunnable mSocketRunnable = new ServerRunnable();
	...
	public static class ActiveConnection
	{
		 ...
		 * transfer.
		 */
		public void reply(String out) throws TimeoutException, IOException
		{
			...
			headerJSON.put(HEADER_ITEM_LENGTH, outputBytes.length);
