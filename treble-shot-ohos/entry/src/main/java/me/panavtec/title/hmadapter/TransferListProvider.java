...
public class TransferListProvider extends BaseListProvider<PreloadedGroup, TransferListProvider.ViewHolder> {

    public TransferListProvider(List<PreloadedGroup> list, Context context) {
        super(list, context);
    }

    @Override
    int getItemLayout() {
        return ResourceTable.Layout_list_transfer_group;
    }
...
//        TransferObject.Type type = object.type;
//        int i = type.compareTo(TransferObject.Type.INCOMING);
        ...
        holder.text4.setText("大小："+ FileUtils.sizeExpression(Long.parseLong(object.getSize()),false));
