...
import com.zxy.recovery.test.TestAbility2;
 ...
 * @since 2021-05-08
 */
public class TestSlice extends AbilitySlice implements Component.ClickedListener {
    @Override
    ...
    public void onClick(Component component) {
        if (component.getId() == ResourceTable.Id_test_btn) {
            ...
            Operation operation = new Intent.OperationBuilder()
                    ...
                    .withAbilityName(TestAbility2.class)
                    .build();
