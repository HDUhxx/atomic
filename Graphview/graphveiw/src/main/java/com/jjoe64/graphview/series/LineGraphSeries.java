...
//    private AccelerateInterpolator mAnimationInterpolator;
    ...
    protected void init() {
        ...
        mSelectionPaint.setColor(new Color(argb));

        mSelectionPaint.setStyle(Paint.Style.FILL_STYLE);
...
//        mAnimationInterpolator = new AccelerateInterpolator(2f);
    ...
    public void draw(GraphView graphView, Canvas canvas, boolean isSecondScale) {
        ...
        mPaintBackground.setColor(new Color(mStyles.backgroundColor));
...
//                              startXAnimated = (startX - lastAnimationReferenceX) * factor + lastAnimationReferenceX;
                                startXAnimated = (startX - lastAnimationReferenceX)  + lastAnimationReferenceX;
...
//                              endXAnimated = (endX - lastAnimationReferenceX) * factor + lastAnimationReferenceX;
                                endXAnimated = (endX - lastAnimationReferenceX)  + lastAnimationReferenceX;
...
//                          first_X = (first_X - lastAnimationReferenceX) * factor + lastAnimationReferenceX;
                            ...
                            first_X = (first_X - lastAnimationReferenceX) + lastAnimationReferenceX;
