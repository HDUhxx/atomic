...
public class PointsGraphSeries<E extends DataPointInterface> extends BaseSeries<E> {
     ...
     * each data point.
     * You can also draw a custom drawing via {@link }
     */
    public enum Shape {
        /**
        ...
        while (values.hasNext()) {
            ...
            if (!overdraw) {
                if (mCustomShape != null) {
                    ...
                    rectFloat.left = endX - mStyles.size;
                    rectFloat.top = endY - mStyles.size;
                    rectFloat.right = endX + mStyles.size;
                    rectFloat.bottom = endY + mStyles.size;
